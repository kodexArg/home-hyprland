...
- **RAM track:** `widget/ram.ts` + `RamTrack.tsx` · 5×3 VRAM/RAM/SWAP · **warn-ahead** (idle 0 cells; red before full: VRAM 70% / RAM 55% / SWAP 35%; RAM floor 32%) · `ags request ram-status` · ADR `20260807-ags-ram-track`
